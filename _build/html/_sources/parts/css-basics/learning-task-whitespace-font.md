# Whitespace and font size observations learning task

```{exercise}
:label: whitespace-font-observation-assignment
...
**Review the following article**: [Awwards what to do with whitespace](https://www.awwwards.com/what-to-do-with-whitespace.html) 
...
- [Pocket Penguins](https://www.pocketpenguins.com/)
- [Juliana Cavalcanti](https://www.juliana-cavalcanti.com/)
- [Sonos](https://www.sonos.com/en-us/home)
- [Shopify](https://www.shopify.com/) (Shopify hosts most small business sites on the web theses days, so their templates help shape popular design)
- [Everlane](https://www.everlane.com/)
- [Simpla](https://www.madesimpla.com/en/)
...
![fonts dev tools](../../images/css-basics/fonts-dev-tools.png)

**Highlight elements in the DOM inspector and view the Layout pane** to see their paddings, borders, and margins.

![dev tools layout](../../images/css-basics/dev-tools-layout.png)
